...
export default function PreAssessment() {
    ...
    const [redirectLoading, setRedirectLoading] = useState(false); // <-- for dashboard button
    ...
    const handleNext = () => {
        ...
        if (currentIndex + 1 < questions.length) {
            ...
            toast.success("You've completed the Pre-Assessment!");
            setShowResults(true);
        }
    };
    ...
    const handleSubmitResults = async () => {
        try {
            setRedirectLoading(true); // start loading on button
                        ...
                        <div className="p-6 rounded space-y-4">
                            ...
                            <div className="max-w-xl mx-auto">
                                <button
                                    ...
                                    className="mt-4 py-2 px-4 w-full bg-primary text-white font-semibold rounded hover:bg-secondary transition flex justify-center items-center gap-2"
                                >
                                    {redirectLoading ? (
                                        <>
                                            <svg
