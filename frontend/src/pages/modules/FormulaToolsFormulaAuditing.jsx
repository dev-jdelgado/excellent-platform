...
export default function FormulaToolsFormulaAuditing() {
    const steps = [
        "Click a cell that contains a formula",
        "Go to the Formulas tab",
        "Use Trace Precedents to see which cells feed into the formula",
        "Use Trace Dependents to see which cells rely on the formula",
    ];

    const tips = [
        "Use Evaluate Formula to step through calculations",
        "Remove Arrows when done to clean up the view",
        "Great for finding why a formula returns an error or unexpected result",
    ];
                    ...
                    <main>
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                Trace and debug formula relationships
                            </p>
                        </div>

                        <div className="mt-6 rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <div className="border-l-4 border-emerald-600 p-5">
                                <p className="font-semibold text-gray-900">What is Formula Auditing?</p>
                                <p className="mt-2 text-sm text-gray-600">
                                    Formula Auditing tools help you visualize and troubleshoot formulas by showing
                                    where values come from and which cells depend on them.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6">
                            <ExcelEngine steps={excelSteps.formulaAuditing} />
                        </div>
