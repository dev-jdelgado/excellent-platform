...
export default function FormulaToolsInsertFunction() {
    ...
    const tips = [
        "Use the function description to understand what each argument means",
        "Start with common functions like SUM, AVERAGE, IF, COUNTIF",
        "If you forget syntax, Insert Function guides you step-by-step",
    ];
                    ...
                    <main>
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                Browse and insert Excel functions easily
                            </p>
                        </div>

                        <div className="mt-6 rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <div className="border-l-4 border-emerald-600 p-5">
                                <p className="font-semibold text-gray-900">What is Insert Function?</p>
                                <p className="mt-2 text-sm text-gray-600">
                                    Insert Function (fx) helps you pick a function and fill in arguments correctly,
                                    making it easier to build formulas without memorizing syntax.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6">
                            <ExcelEngine steps={excelSteps.insertFunction} />
                        </div>
