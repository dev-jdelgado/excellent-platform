...
import { ChevronRightIcon, ArrowLeftIcon, CalculatorIcon } from "@heroicons/react/24/outline";

export default function FormulaTools() {
    const lessons = [
        {
            title: "Insert Function",
            description: "Browse and insert Excel functions easily",
            to: "/excel-tools/formula-tools/insert-function",
        },
        {
            title: "Formula Auditing",
            description: "Trace and debug formula relationships",
            to: "/excel-tools/formula-tools/formula-auditing",
        },
    ];
