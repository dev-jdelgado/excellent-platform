...
import { ChevronRightIcon, ArrowLeftIcon, WrenchIcon } from "@heroicons/react/24/outline";

export default function Formatting() {
    const lessons = [
        {
            title: "Cell Formatting",
            description: "Change fonts, colors, borders and alignment",
            to: "/excel-tools/formatting/cell-formatting",
        },
        {
            title: "Conditional Formatting",
            description: "Automatically format cells based on their values",
            to: "/excel-tools/formatting/conditional-formatting",
        },
    ];
                        ...
                        <div className="mt-4 flex items-center gap-3">
                            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-white border border-emerald-100">
                                ...
                                <p className="text-sm text-gray-600">
                                    Make your spreadsheet clear and professional
                                </p>
                            </div>
                        </div>
