...
import { ChevronRightIcon, ArrowLeftIcon, PhotoIcon } from "@heroicons/react/24/outline";
    ...
    const lessons = [
        {
            ...
            to: "/excel-tools/insert-elements/insert-table",
        },
        {
            title: "Insert Chart",
            description: "Create visual representation of your data",
            to: "/excel-tools/insert-elements/insert-chart",
        },
    ];
                        ...
                        <div className="mt-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Add tables, charts, and visual elements
                                </p>
                            </div>
                        </div>
