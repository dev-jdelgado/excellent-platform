...
export default function DataManagementFilterData() {
    const steps = [
        "Select a cell inside your data range (or select your table)",
        "Go to the Data tab",
        "Click Filter to add dropdowns to column headers",
        "Click a header dropdown and choose values or use Text/Number/Date Filters",
    ];

    const tips = [
        "Use Clear Filter to show everything again",
        "You can filter multiple columns at the same time",
        "Convert your range to a Table (Ctrl + T) for smoother filtering",
    ];
                    ...
                    <main>
                        ...
                        <div className="mt-6 rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <div className="border-l-4 border-emerald-600 p-5">
                                <p className="font-semibold text-gray-900">What is Filter?</p>
                                <p className="mt-2 text-sm text-gray-600">
                                    Filtering hides rows that don’t match your chosen conditions, so you can focus
                                    only on the data you need—without deleting anything.
                                </p>
                            </div>
                        </div>
