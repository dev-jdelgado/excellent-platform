...
export default function InsertElementsInsertChart() {
    const steps = [
        "Select the data range you want to visualize (include headers)",
        "Go to the Insert tab",
        "Choose a chart type (Column, Line, Pie, etc.)",
        "Adjust chart title, labels, and formatting as needed",
    ];

    const tips = [
        "Column charts work great for comparisons; line charts are best for trends",
        "Keep charts simple—avoid too many colors or data series",
        "Use chart titles and axis labels so viewers understand the data quickly",
    ];
                    ...
                    <main>
                        ...
                        <div className="mt-6 rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <div className="border-l-4 border-emerald-600 p-5">
                                <p className="font-semibold text-gray-900">What is a Chart?</p>
                                <p className="mt-2 text-sm text-gray-600">
                                    Charts help you understand data faster by turning numbers into visuals like
                                    bars, lines, or slices—useful for reports and presentations.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6">
                            <ExcelEngine steps={excelSteps.insertChart} />
                        </div>
                        ...
                        <div className="mt-6 rounded-2xl border border-gray-200 bg-white shadow-sm p-5">
                            ...
                            <div className="mt-4 rounded-xl overflow-hidden border border-gray-200">
                                <video
                                    ...
                                    preload="metadata"
                                >
                                    <source src="/videos/INSERTING GRAPH AND CHART.mp4"  type="video/mp4" />
