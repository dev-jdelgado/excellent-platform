                    ...
                    <main>
                        ...
                        <div className="mt-4 rounded-2xl border border-gray-200 bg-white shadow-sm p-5">
                            ...
                            <div className="mt-4">
                                ...
                                <MonoBox>=CONCATENATE(A2, " ", B2)</MonoBox>
                            </div>

                            <div className="mt-4 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                                <p className="text-sm text-gray-700">Result</p>
                                <p className="mt-1 font-semibold text-emerald-900">John Doe</p>
                            </div>

                            <p className="mt-3 text-sm text-gray-600">Combines first and last name with a space.</p>
                        </div>
